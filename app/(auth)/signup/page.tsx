...
export default function SignUp() {
  return (
    <section className="bg-gradient-to-b from-gray-100 to-black">
          ...
          <div className="max-w-sm mx-auto">
            <form>
              ...
              <div className="flex flex-wrap -mx-3 mt-6">
                <div className="w-full px-3">
                  <button className="btn text-black bg-teal-600 hover:bg-teal-700 w-full">Sign up</button>
                </div>
              </div>
            ...
            <form>
              <div className="flex flex-wrap -mx-3 mb-3">
                <div className="w-full px-3">
                  <button className="btn px-0 text-black bg-gray-900 hover:bg-gray-800 w-full relative flex items-center">
            ...
            <div className="text-gray-600 text-center mt-6">
              Already using Simple? <Link href="https://app.fumedev.com/signin" className="text-teal-600 hover:underline transition duration-150 ease-in-out">Sign in</Link>
            </div>
          </div>
